"""
Some examples of how to use the deeppersona library. These can be used directly or slightly modified to create your own '
agents.
"""
import os
...
def create_oscar_the_architect(enable_browser=False):
  return DeepPersona.load_specification(load_example_agent_specification("Oscar"), new_agent_name="Oscar", auto_rename_agent=False)
...
def create_oscar_the_architect_2(enable_browser=False):
  ...
  """ 
  oscar = DeepPersona("Oscar", enable_browser=enable_browser)
...
def create_lisa_the_data_scientist(enable_browser=False):
  return DeepPersona.load_specification(load_example_agent_specification("Lisa"), new_agent_name="Lisa", auto_rename_agent=False)
...
def create_lisa_the_data_scientist_2(enable_browser=False):
  ...
  """
  lisa = DeepPersona("Lisa", enable_browser=enable_browser)
...
def create_marcos_the_physician(enable_browser=False):
  return DeepPersona.load_specification(load_example_agent_specification("Marcos"), new_agent_name="Marcos", auto_rename_agent=False)
...
def create_marcos_the_physician_2(enable_browser=False):
  ...
  marcos = DeepPersona("Marcos", enable_browser=enable_browser)
...
def create_lila_the_linguist(enable_browser=False):
  return DeepPersona.load_specification(load_example_agent_specification("Lila"), new_agent_name="Lila", auto_rename_agent=False)
...
def create_lila_the_linguist_2(enable_browser=False):
  ...
  lila = DeepPersona("Lila", enable_browser=enable_browser)
