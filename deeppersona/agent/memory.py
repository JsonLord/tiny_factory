...
from deeppersona.agent.mental_faculty import DeepMentalFaculty
from deeppersona.agent.grounding import BaseSemanticGroundingConnector
...
class DeepMemory(DeepMentalFaculty):
    """
...
class EpisodicMemory(DeepMemory):
    """
...
@utils.post_init
class SemanticMemory(DeepMemory):
    """
