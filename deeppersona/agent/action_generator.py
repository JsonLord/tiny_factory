...
from deeppersona.validation import propositions
...
class ActionGenerator(JsonSerializableRegistry):
    ...
    def generate_next_action(self, agent, current_messages:list):
        ...
        from deeppersona.agent import logger # import here to avoid circular import issues
    ...
    def _generate_tentative_action(self, agent, current_messages, feedback_from_previous_attempt=None, 
        ...
        from deeppersona.agent import logger, CognitiveActionModel, CognitiveActionModelWithReasoning # import here to avoid circular import issues
