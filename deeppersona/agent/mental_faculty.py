from deeppersona.agent import logger
from deeppersona.agent.grounding import LocalFilesGroundingConnector, WebPagesGroundingConnector
from deeppersona.utils import JsonSerializableRegistry
import deeppersona.utils as utils

import deeppersona.agent as agent
...
class DeepMentalFaculty(JsonSerializableRegistry):
    """
    ...
    def __eq__(self, other):
        if isinstance(other, DeepMentalFaculty):
...
class CustomMentalFaculty(DeepMentalFaculty):
    """
...
class RecallFaculty(DeepMentalFaculty):
...
class FilesAndWebGroundingFaculty(DeepMentalFaculty):
    """
...
class DeepToolUse(DeepMentalFaculty):
    """
...
class SequentialThinkingFaculty(DeepMentalFaculty):
    def __init__(self):
        super().__init__("Sequential Thinking")
        from deeppersona.tools.sequential_thinking import SequentialThinkingTool
