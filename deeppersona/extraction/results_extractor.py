...
from deeppersona import openai_utils
...
class ResultsExtractor:
    ...
    def extract_results_from_agents(self,
                                    ...
                                    verbose:bool=None):
        """
        Extracts results from a list of DeepPersona instances.

        Args:
            agents (List[DeepPersona]): The list of DeepPersona instances to extract results from.
    ...
    def extract_results_from_agent(self, 
                        ...
                        verbose:bool=None):
        """
        Extracts results from a DeepPersona instance.

        Args:
            deeppersona (DeepPersona): The DeepPersona instance to extract results from.
            extraction_objective (str): The extraction objective.
            situation (str): The situation to consider.
            fields (list, optional): The fields to extract. If None, the extractor will decide what names to use. 
                Defaults to None.
        ...
        interaction_history = deeppersona.pretty_current_interactions(max_content_length=None)
...
## Situation
You are considering a single agent, named {deeppersona.name}. Your objective thus refers to this agent specifically.
{situation}
...
"""
        ...
        # cache the result
        self.agent_extraction[deeppersona.name] = result
