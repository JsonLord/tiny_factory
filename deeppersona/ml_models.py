...
from deeppersona.features import ContentFeatureExtractor, PersonaFeatureExtractor, InteractionFeatureExtractor
from deeppersona.agent.agent_traits import TraitBasedBehaviorModel
...
class EngagementPredictor:
    ...
    def predict(self, persona: DeepPersona, content: Content, network: NetworkTopology) -> float:
