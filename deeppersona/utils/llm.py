...
from deeppersona.utils import logger
from deeppersona.utils.rendering import break_text_at_length
...
class LLMChat:
    ...
    def call(self, output_type="default", 
        ...
        """
        from deeppersona.openai_utils import client # import here to avoid circular import
...
def add_rai_template_variables_if_enabled(template_variables: dict) -> dict:
    ...
    from deeppersona import config # avoids circular import
