...
from deeppersona.experimentation import Proposition
...
class Intervention:
    ...
    def __init__(self, targets: Union[DeepPersona, DeepWorld, List[DeepPersona], List[DeepWorld]],
        ...
        Args:
            target (Union[DeepPersona, DeepWorld, List[DeepPersona], List[DeepWorld]]): the target to intervene on
    ...
    def create_for_each(cls, targets, first_n=DEFAULT_FIRST_N, last_n=DEFAULT_LAST_N, name=None):
        ...
        Args:
            targets (list): List of targets (DeepPersona or DeepWorld instances)
            first_n (int): the number of first interactions to consider in the context
            last_n (int): the number of last interactions (most recent) to consider in the context
            name (str): the name of the intervention
    ...
    def set_functional_precondition(self, func):
        ...
        Args:
            func (function): the function of the precondition. 
              Must have the a single argument, targets (either a DeepWorld or DeepPersona, or a list). Must return a boolean.
        """
