...
class DeepStory:
    """
    Every simulation tells a story. This class provides helper mechanisms to help with crafting appropriate stories in DeepPersona.
    """


    def __init__(self, environment:DeepWorld=None, agent:DeepPersona=None, purpose:str="Be a realistic simulation.", context:str="",
        ...
        Args:
            environment (DeepWorld, optional): The environment in which the story takes place. Defaults to None.
            agent (DeepPersona, optional): The agent in the story. Defaults to None.
