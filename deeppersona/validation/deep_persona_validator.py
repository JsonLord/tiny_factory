...
from deeppersona import config
...
class DeepPersonaValidator:
    ...
    def validate_person(person, expectations=None, include_agent_spec=True, max_content_length=default_max_content_display_length) -> tuple[float, str]:
        """
        Validate a DeepPersona instance using OpenAI's LLM.

        This method sends a series of questions to the DeepPersona instance to validate its responses using OpenAI's LLM.
        ...
        Args:
            person (DeepPersona): The DeepPersona instance to be validated.
