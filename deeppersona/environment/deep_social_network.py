...
from deeppersona.environment import logger
...
class DeepSocialNetwork(DeepWorld):

    def __init__(self, name, broadcast_if_no_target=True):
        """
        Create a new DeepSocialNetwork environment.
    ...
    def add_relation(self, agent_1, agent_2, name="default"):
        ...
        Args:
            agent_1 (DeepPersona): The first agent.
            agent_2 (DeepPersona): The second agent.
    ...
    def is_in_relation_with(self, agent_1:DeepPersona, agent_2:DeepPersona, relation_name=None) -> bool:
        """
